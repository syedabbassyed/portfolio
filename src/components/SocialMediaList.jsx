        ...
        <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
            <li className="mr-5 shrink-0 text-xs">
                <a
                    ...
                    href="https://github.com/syedabbassyed"
                    target="_blank"
            ...
            <li className="mr-5 shrink-0 text-xs">
                <a
                    className="block hover:text-white"
                    href="https://www.linkedin.com/in/syedabbassa/"
                    target="_blank"
                    rel="noreferrer noopener"
            ...
            <li className="mr-5 shrink-0 text-xs">
                <a
                    className="block hover:text-white"
                    href="mailto:syedabbassyed786@gmail.com"
                    target="_blank"
                    rel="noreferrer noopener"
                ...
                >
                    ...
                    <svg fill="currentColor" className="h-6 w-6" aria-hidden="true" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        <title>mail</title>
